...
lines.append(silk_text("U1 XIAO-ESP32S3", XIAO_X, XIAO_Y-12.5, size=1.0))
lines.append(silk_text("USB-C (built-in)", XIAO_X, XIAO_Y-14.0, size=0.7))
lines.append(silk_text("J4 ALPS-JOY",     JOY_X,  JOY_Y-13,    size=1.0))
lines.append(silk_text("J3 FPC-UP",        FPC3_X, FPC3_Y+4,    size=0.8))
lines.append(silk_text("J2 LIPO",          BAT_X,  BAT_Y-4,     size=0.8))
lines.append(silk_text("SW_BT SYNC",       SWBT_X, SWBT_Y+4.5,  size=0.8))
lines.append(silk_text("LOWER PCB R3.0",   BX,     BY+37,       size=0.8))
...
lines_u.append(silk_text("J5 FPC-DN",   fpc5_x,  fpc5_y+4, size=0.8))
lines_u.append(silk_text("UPPER R1.9",  UBX,     UBY+22,   size=0.8))
