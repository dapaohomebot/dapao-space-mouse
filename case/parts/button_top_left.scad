// ============================================================
// DaPao Space Mouse — Part 5: Left Top Button (v3)
// Plunger position updated to match SW4 on upper PCB (X=-10, Y=+12).
...
module top_button_left() {
    ...
    union() {
        ...
        // Plunger post — matches SW4 position on PCB: X=-10mm, Y=+12mm
